...
@pytest.mark.parametrize("context_element, disallowedlist, version", [
    ...
    ('abstract', ['@lang', '@{%(xml)s}lang' % NAMESPACES, '@script',
                  '@transliteration'], '3.4'),
    ('accessCondition', ['@authority', '@authorityURI', '@valueURI',
                         '@ID'], '3.8'),
