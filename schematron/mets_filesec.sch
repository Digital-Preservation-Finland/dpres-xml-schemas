...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" schemaVersion="1.8.0">
...
-->
        ...
        <sch:let name="mix_types" value="string('image/x-adobe-dng image/tiff image/jpeg image/jp2 image/png image/gif image/x-dpx image/webp')"/>
        <sch:let name="videomd_types" value="string('video/jpeg2000 video/h264 video/dv video/mpeg video/x-ms-wmv video/x-ffv video/h265')"/>
        ...
        <sch:pattern id="no_validation_bitlevel_migration_or_conversion">
                <sch:rule context="mets:fileGrp/mets:file[(normalize-space(@USE)='fi-dpres-no-file-format-validation')]">
                        ...
                        <sch:let name="conversion_events_bitlevel_as_outcome" value="exsl:node-set($digiprovmd_conversion/mets:mdWrap/mets:xmlData/premis:event/premis:linkingObjectIdentifier[normalize-space(./premis:linkingObjectRole)='outcome' and normalize-space(./premis:linkingObjectIdentifierValue)=$bitlevel_object_id and (normalize-space(following-sibling::premis:linkingObjectIdentifier/premis:linkingObjectRole)='source' or normalize-space(preceding-sibling::premis:linkingObjectIdentifier/premis:linkingObjectRole)='source')]/..)"/>
                        <sch:let name="conversion_events_bitlevel_not_as_source" value="exsl:node-set($digiprovmd_conversion/mets:mdWrap/mets:xmlData/premis:event/premis:linkingObjectIdentifier[normalize-space(./premis:linkingObjectRole)='source' and not(normalize-space(./premis:linkingObjectIdentifierValue)=$bitlevel_object_id)]/..)"/>
                        <sch:let name="events_with_ok_links" value="sets:intersection($migration_events_bitlevel_as_source, $migration_events_bitlevel_not_as_outcome) | sets:intersection($conversion_events_bitlevel_as_outcome, $conversion_events_bitlevel_not_as_source)"/>
        ...
        <sch:pattern id="ignore_validation_error_broken_bitlevel_identification">
                <sch:rule context="mets:fileGrp/mets:file[(normalize-space(@USE)='fi-dpres-ignore-validation-errors')]">
                        ...
                        <sch:let name="migration_events_bitlevel_as_source" value="exsl:node-set($digiprovmd_migration/mets:mdWrap/mets:xmlData/premis:event/premis:linkingObjectIdentifier[normalize-space(./premis:linkingObjectRole)='source' and normalize-space(./premis:linkingObjectIdentifierValue)=$bitlevel_object_id and (normalize-space(following-sibling::premis:linkingObjectIdentifier/premis:linkingObjectRole)='outcome' or normalize-space(preceding-sibling::premis:linkingObjectIdentifier/premis:linkingObjectRole)='outcome')]/..)"/>
                        <sch:let name="migration_events_bitlevel_not_as_outcome" value="exsl:node-set($digiprovmd_migration/mets:mdWrap/mets:xmlData/premis:event/premis:linkingObjectIdentifier[normalize-space(./premis:linkingObjectRole)='outcome' and not(normalize-space(./premis:linkingObjectIdentifierValue)=$bitlevel_object_id)]/..)"/>
                        <sch:let name="conversion_events_broken_as_source" value="exsl:node-set($digiprovmd_conversion/mets:mdWrap/mets:xmlData/premis:event/premis:linkingObjectIdentifier[normalize-space(./premis:linkingObjectRole)='source' and normalize-space(./premis:linkingObjectIdentifierValue)=$bitlevel_object_id and (normalize-space(following-sibling::premis:linkingObjectIdentifier/premis:linkingObjectRole)='outcome' or normalize-space(preceding-sibling::premis:linkingObjectIdentifier/premis:linkingObjectRole)='outcome')]/..)"/>
                        <sch:let name="conversion_events_broken_not_as_outcome" value="exsl:node-set($digiprovmd_conversion/mets:mdWrap/mets:xmlData/premis:event/premis:linkingObjectIdentifier[normalize-space(./premis:linkingObjectRole)='outcome' and not(normalize-space(./premis:linkingObjectIdentifierValue)=$bitlevel_object_id)]/..)"/>
                        <sch:let name="events_with_ok_links" value="sets:intersection($migration_events_bitlevel_as_source, $migration_events_bitlevel_not_as_outcome) | sets:intersection($conversion_events_broken_as_source, $conversion_events_broken_not_as_outcome)"/>
        ...
        <!-- Checks for forensically analysed files (files with errors that can be accepted after forensic analysis has been performed and a derivative file is supplied).
             Conversion and forensic feature analysis events are required for these files
             Reports on analysis requirement. -->
        <sch:pattern id="check_forensic_analysis_event_for_forensically_analysed_object">
        ...
        <sch:pattern id="check_conversion_event_for_forensically_analysed_object">
                <sch:rule context="mets:fileGrp/mets:file[(normalize-space(@USE)='fi-dpres-preserve-forensically-analysed-object')]">
                        <sch:let name="admid" value="normalize-space(@ADMID)"/>
                        <sch:let name="analysis_object_techmd_id" value="normalize-space($techmd/@ID[contains(concat(' ', $admid, ' '), concat(' ', normalize-space(.), ' ')) and (normalize-space(../mets:mdWrap/mets:xmlData/premis:object/@xsi:type)='premis:file' or normalize-space(../mets:mdWrap/mets:xmlData/premis:object/@xsi:type)='premis:bitstream')])"/>
                        <sch:let name="analysis_object_id" value="normalize-space($techmd[normalize-space(@ID) = $analysis_object_techmd_id]/mets:mdWrap/mets:xmlData/premis:object/premis:objectIdentifier/premis:objectIdentifierValue)"/>

                        <sch:let name="conversion_events_analysis_object_as_source" value="exsl:node-set($digiprovmd_conversion/mets:mdWrap/mets:xmlData/premis:event/premis:linkingObjectIdentifier[normalize-space(./premis:linkingObjectRole)='source' and normalize-space(./premis:linkingObjectIdentifierValue)=$analysis_object_id and (normalize-space(following-sibling::premis:linkingObjectIdentifier/premis:linkingObjectRole)='outcome' or normalize-space(preceding-sibling::premis:linkingObjectIdentifier/premis:linkingObjectRole)='outcome')]/..)"/>
                        <sch:let name="conversion_events_analysis_object_not_as_outcome" value="exsl:node-set($digiprovmd_conversion/mets:mdWrap/mets:xmlData/premis:event/premis:linkingObjectIdentifier[normalize-space(./premis:linkingObjectRole)='outcome' and not(normalize-space(./premis:linkingObjectIdentifierValue)=$analysis_object_id)]/..)"/>
                        <sch:let name="conversion_events_with_ok_links" value="sets:intersection($conversion_events_analysis_object_as_source, $conversion_events_analysis_object_not_as_outcome)"/>

                        <sch:assert test="(count($digiprovmd_conversion) &gt; 0 and count($digiprovmd_conversion/@ID[contains(concat(' ', $admid, ' '), concat(' ', normalize-space(.), ' '))]) &gt; 0)">
                                Value '<sch:value-of select="@USE"/>' in attribute '<sch:value-of select="name(@USE)"/>' found for file '<sch:value-of select="./mets:FLocat/@xlink:href"/>'. Succeeded PREMIS event for conversion is required.
                        </sch:assert>
                        <sch:assert test="count($digiprovmd_conversion) = 0 or count($conversion_events_with_ok_links) &gt; 0">
                            Value '<sch:value-of select="@USE"/>' in attribute '<sch:value-of select="name(@USE)"/>' found for file '<sch:value-of select="./mets:FLocat/@xlink:href"/>'. PREMIS event for conversion contains ambiguous links to object identifiers.
                        </sch:assert>
                        <sch:report test="(count($digiprovmd_conversion) &gt; 0 and count($digiprovmd_conversion/@ID[contains(concat(' ', $admid, ' '), concat(' ', normalize-space(.), ' '))]) &gt; 0) and count($conversion_events_with_ok_links) &gt; 0">
                                INFO: Value '<sch:value-of select="@USE"/>' in attribute '<sch:value-of select="name(@USE)"/>' found for file '<sch:value-of select="./mets:FLocat/@xlink:href"/>'. File requiring forensic analysis is supplied with a derivative version.
                        </sch:report>
                </sch:rule>
        </sch:pattern>
