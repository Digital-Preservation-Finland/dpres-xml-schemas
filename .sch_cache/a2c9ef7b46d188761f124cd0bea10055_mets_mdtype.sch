...
-->
	...
	<sch:pattern id="audiomd_requirement_stream">
        <sch:rule context="mets:stream">
			...
			or contains(' 1.4 1.4.1 1.5.0 ', concat(' ',normalize-space(ancestor-or-self::mets:mets/@fi:CATALOG),' ')) or contains(' 1.4 1.4.1 1.5.0 ', concat(' ',normalize-space(ancestor-or-self::mets:mets/@fi:SPECIFICATION),' '))">
